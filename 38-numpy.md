---
title: "3.8 Reading and analysing Patient data using libraries"
teaching: 20
exercises: 5
---
...
These both need to be character strings (strings) for short),
...
![Operations Across Axes](fig/python-figs/python-operations-across-axes.svg){alt="performing operations across axes"}
