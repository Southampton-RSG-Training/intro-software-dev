...
![](fig/git-figs/01-background/revisions.gif){width="25%" alt="Manual version control"}
...
![](fig/git-figs/01-background/track_changes.svg){width="45%" alt="Changes are tracked sequentially"}
...
![](fig/git-figs/01-background/versions.svg){width="30%" alt="Different versions can be saved"}
...
![](fig/git-figs/01-background/merge.svg){width="30%" alt="Multiple versions can be merged"}
...
This isn't the only way to use it, however. There are many different graphical user interfaces for Git, like:

| [SourceTree](https://www.sourcetreeapp.com/) | [Git Kraken](https://www.gitkraken.com/) | [GitHub Desktop](https://desktop.github.com/) |
| ---------- | ---------- | -------------- |
| ![SourceTree](fig/git-figs/01-background/sourcetree.png){width="100%" alt="SourceTree"} | ![Git Kraken](fig/git-figs/01-background/kraken.png){width="100%" alt="Git Kraken"} | ![GitHub Desktop](fig/git-figs/01-background/desktop.png){width="100%" alt="GitHub Desktop"} |
...
You can, for example, manage your code on Iridis using command-line git and GitHub Desktop on your desktop workstation.
...
| ---------- | ---------- | -------------- |
| ![VS Code](fig/git-figs/01-background/integration-vscode.png){width="100%" alt="VS Code"} | ![PyCharm](fig/git-figs/01-background/integration-pycharm.png){width="100%" alt="PyCharm"} | ![RStudio](fig/git-figs/01-background/integration-rstudio.png){width="100%" alt="RStudio"} |
