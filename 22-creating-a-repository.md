---
title: "2.2 Creating a Repository"
...
![](fig/git-figs/03-create/template-copy.png){alt="Use Template"}
...
![](fig/git-figs/03-create/template-details.png){alt="Repository Details"}
