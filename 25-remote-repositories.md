...
![](fig/git-figs/06-remote/local.png){width="60%" alt="Local Repository Commands"}
...
![](fig/git-figs/06-remote/mountbatten-fire.jpg){width="60%" alt="Mountbatten Fire"}
...
![](fig/git-figs/06-remote/remote.svg){width="60%" alt="Remote Repositories"}
...
![](fig/git-figs/06-remote/github.png){alt="Updated remote repository"}
...
![In case of fire, git commit, git push, leave building](fig/git-figs/06-remote/incaseoffire.jpg){alt="In case of fire, git commit, git push, leave building"}
...
![](fig/git-figs/06-remote/edit-button.png){alt="GitHub edit button"}

And just expand it a little, making more use of GitHub's markdown formatting:

![](fig/git-figs/06-remote/edit-readme.png){alt="GitHub editing Readme"}

Then commit the changes directly to our `main` branch with a descriptive commit message:

![](fig/git-figs/06-remote/edit-commit.png){alt="GitHub committing edit"}

![](fig/git-figs/06-remote/github-updated.png){alt="Updated remote repository"}
...
![](fig/git-figs/06-remote/conflict-resolved.png){alt="Resolved conflict on GitHub"}
...
![](fig/git-figs/06-remote/remote.png){width="60%" alt="Remote Repository Commands"}
