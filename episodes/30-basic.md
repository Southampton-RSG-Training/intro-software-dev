...
![Variables as Sticky Notes](fig/python-figs/python-sticky-note-variables-01.svg){alt='Diagram showing a sticky note labelled weight_kg attached to the value 55.'}
...
![Creating Another Variable](fig/python-figs/python-sticky-note-variables-02.svg){alt='Diagram showing two sticky notes, weight_kg and weight_lb, attached to their respective values.'}
...
![Updating a Variable](fig/python-figs/python-sticky-note-variables-03.svg){alt='Diagram showing the weight_kg sticky note moved to a new value, while weight_lb stays attached to its original value.'}
...
::::::::::::::::::::::::::::::::::::: challenge
## Challenge 1: What's inside the box?
