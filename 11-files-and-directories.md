---
title: "1.1 Files and Directories"
...
2. **Using `man`**: The `man` command (available on Linux and macOS), short for '**manual**', provides comprehensive documentation for most commands and programs. To access the manual for a specific command, simply use `man` followed by the command's name, such as:
...
::::::::::::::::::::::::::::::::::::: challenge
## Challenge 2: `ls` reading comprehension
