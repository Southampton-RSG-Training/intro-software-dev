...
![](fig/git-figs/07-branches/git-feature-branch.svg){width="60%" alt="Git Feature-branch workflow"}
...
![](fig/git-figs/07-branches/push-dev.png){alt="Switching branch on GitHub"}
...
![](fig/git-figs/07-branches/push-dev-selected.png){alt="Viewing dev branch on GitHub"}
...
![](fig/git-figs/07-branches/push-main.png){alt="Main up-to-date on GitHub"}
...
![](fig/git-figs/07-branches/push-dev-selected.png){alt="Main up-to-date on GitHub"}
...
![](fig/git-figs/07-branches/pull-request-example.png){alt="Pull request on GitHub"}
